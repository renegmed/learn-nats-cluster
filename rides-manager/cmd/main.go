...
import (
	...
	"github.com/renegmed/ridesmanager/kit"
	"github.com/renegmed/ridesmanager/server"
)
...
func main() {
	...
	flag.StringVar(&natsServers, "nats", "", "List of NATS Servers to connect. Do ") // required to pass nats URLs
	flag.Parse()
